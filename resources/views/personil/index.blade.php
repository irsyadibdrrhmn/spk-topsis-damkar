    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                {{ __('Data Personil Pemadam Kebakaran') }}
            </h2>
            <a href="{{ route('personil.create') }}" class="btn-primary">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('personil.edit', $p) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-600 mr-3">Edit</a>
                                        <form action="{{ route('personil.destroy', $p) }}" method="POST" class="inline-block" onsubmit="return confirm('Yakin ingin menghapus data personil ini?')">
                                            @csrf
                                            @method('DELETE')
                                ...
                                <tr>
                                    <td colspan="5" class="px-6 py-4 text-center text-gray-500 dark:text-gray-400">
                                        Belum ada data personil. <a href="{{ route('personil.create') }}" class="text-blue-600 hover:text-blue-900">Tambah data</a>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
