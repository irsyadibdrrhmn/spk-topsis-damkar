    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-lg shadow-lg p-6 mb-6">
                ...
                <p class="text-blue-100">Sistem Penilaian Kinerja Tenaga PPK - Disdukcapil</p>
            </div>
                ...
                <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-gray-500 dark:text-gray-400">Total Tenaga PPK</p>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">Top 5 Kinerja Terbaik Bulan Ini</h3>
                    @php
                ...
                <a href="{{ route('topsis.ranking') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">Hasil perangkingan TOPSIS</p>
                        </div>
                    </div>
                </a>

                <a href="{{ route('evaluations.index') }}" class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition">
                    <div class="flex items-center">
                        <div class="flex-shrink-0 bg-green-500 rounded-md p-3">
                            <svg class="h-8 w-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="ml-4">
                            <h4 class="text-lg font-semibold text-gray-900 dark:text-gray-100">Data Penilaian</h4>
                            <p class="text-sm text-gray-500 dark:text-gray-400">Kelola penilaian kinerja</p>
                        </div>
                    </div>
                </a>
            </div>
