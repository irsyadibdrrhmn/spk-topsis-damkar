<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('evaluations.create') }}" class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 active:bg-blue-900 focus:outline-none focus:border-blue-900 focus:ring focus:ring-blue-300 disabled:opacity-25 transition">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">
                        Data Penilaian - {{ \Carbon\Carbon::parse($period . '-01')->format('F Y') }}
                    </h3>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            ...
                            <tbody class="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <tr>
                                    ...
                                    @foreach($criteria as $c)
                                        @php
                                            $eval = $ppk->evaluations->where('criteria_id', $c->id)->first();
                                        @endphp
                                    ...
                                    <td class="px-6 py-4 text-center text-sm font-medium">
                                        @if($ppk->evaluations->count() > 0)
                                            <a href="{{ route('evaluations.edit', [$ppk->id, $period]) }}" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-600">
                                                Edit
                                            </a>
                                        @else
                                            <a href="{{ route('evaluations.edit', [$ppk->id, $period]) }}" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-600">
                                                Nilai
                                            </a>
                                        @endif
                                    </td>
