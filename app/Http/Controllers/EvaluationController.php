...
class EvaluationController extends Controller
{
    public function index(Request $request)
    {
        ...
        $ppks = User::where('role', 'ppk')->with(['evaluations' => function($q) use ($period) {
        ...
        return view('evaluations.index', compact('ppks', 'criteria', 'period', 'periods'));
    }
    ...
    public function create()
    {
        ...
        $criteria = Criteria::all();
        return view('evaluations.create', compact('ppks', 'criteria'));
    }
    ...
    public function edit($userId, $period)
    {
        ...
        return view('evaluations.edit', compact('ppk', 'criteria', 'evaluations', 'period'));
    }
